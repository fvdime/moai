        ...
        <div className='h-screen w-full lg:w-2/5 bg-zinc-950 p-4 md:p-8 xl:p-12 flex flex-col items-start justify-between'>
          <div className='w-full h-4/5 flex flex-col items-center justify-center gap-8'>
            ...
            <div className='w-full flex flex-col md:flex-row items-center justify-around'>
              <button className='border-zinc-100 px-12 xl:px-16 py-2 rounded hover:text-zinc-950 hover:bg-zinc-100 font-bold border transition-all duration-500 ease-in'>{LoginButton}</button>
              <button className='border-zinc-100 px-12 xl:px-16 py-2 rounded hover:text-zinc-950 hover:bg-zinc-100 font-bold border transition-all duration-500 ease-in'>{RegisterButton}</button>
            </div>
          </div>
