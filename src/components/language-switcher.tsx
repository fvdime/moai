...
const LanguageSwitcher = ({enHref, deHref, esHref, jaHref}: LanguageSwitcherProps) => {
  ...
  return (
    <div>    
      <button className="text-white focus:ring-4 focus:outline-none rounded-3xl text-xs px-4 py-1.5 text-center inline-flex items-center bg-zinc-600 hover:bg-zinc-700 focus:ring-zinc-800" type="button"
