...
<div className="flex items-start gap-2.5 mt-4">
   <img className="w-8 h-8 rounded-full" src="/1.jpg" alt="Jese image" />
   <div className="flex flex-col w-full leading-1.5 p-4 border border-zinc-700 rounded-e-xl rounded-es-xl bg-zinc-800 hover:border-zinc-500 ease-in transition-all duration-500">
      <div className="flex items-center justify-between space-x-2 rtl:space-x-reverse mb-2">
          <span className="text-xs font-bold text-white">another user</span>
            <span className="text-xs font-normal text-zinc-400">11:46</span>
        </div>
        <p className="text-md font-semibold text-white">This is the title</p>
      <p className="text-sm font-normal py-2.5 text-zinc-900 dark:text-white">Lorem ipsum dolor, sit amet consectetur adipisicing elit. A sit officia beatae aperiam, vitae totam maiores neque fugit veniam quibusdam omnis, impedit nobis! Eaque ipsa asperiores perferendis commodi ea! Reprehenderit. Lorem ipsum dolor sit amet consectetur adipisicing elit. Corrupti iure perspiciatis odio ut repudiandae beatae doloribus ipsam cumque, nisi sapiente, quo recusandae unde modi quasi iusto ab eligendi sed officia!</p>
   </div>
</div>
    </div>
  );
